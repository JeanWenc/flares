                                                   ...
                                                   tabsetPanel(selected="Results",
                                                               ...
                                                               tabPanel("Methods",
                                                                        ...
                                                                        HTML(paste("<div class='divShadow'>",
                                                                                   ...
                                                                                   "</ul></br>",
                                                                                   "<b>2. Successive count</b>: counts across lists the number of times any two items are mentioned consecutively one after/before the other.</br>",
                                                                        ...
                                                                        HTML(paste("<div class='divShadow'>",
                                                                                   ...
                                                                                   "If you have uploaded item categorical information users may choose to color-code the plot labels according to one of the uploaded items' category (for each category, its sub-categories are plotted with a different color).</br>",
                                                                                   "<i>N.B. For item categorical information that was provided by each respondent, each item assigned to the sub-category which was the most often mentioned for that item. When ties occur (e.g. 10 respondents mentioned they liked the item 'bee' and ten other mentioned they disliked the item 'bee') tie sub-categories (e.g. like_dislike) are created (only for plotting purposes).</i></li>",
                                                                                   "</ul></div>",sep="")),
                                                                        HTML(paste("<div class='divShadow'>",
                                                                                   ...
                                                                                   "<p><b>The optimal partition is chosen as the one maximizing relative intertia loss.</b> In other words the partition for which clusters are the less heterogeneous.</p>",
                                                                                   "<p>Users may choose to include this 'best' partition for analyses on item categorical information provided in the sub-tab 'Item categories analysis'.</br>",
                                                   ...
                                                   tabsetPanel(type="pills",
                                                               ...
                                                               tabPanel("Methods",
                                                                        ...
                                                                        HTML(paste("<div class='divShadow'>",
                                                                                   ...
                                                                                   "<ul>",
                                                                                   "<li>The score (B) is calaculated for each respondent and ranges from 0 to 1 (0 indicating extreme minimum bias, 1 indicating extreme maximum bias and 0.5 inidicating no bias whatsoever).</li>",
                                                                                   ...
                                                                                   "<i>Please refer to the above mentioned article for details on the methods used to calculate the B score.</i></p>",
                                                                                   "</br>",
                                                                        ...
                                                                        HTML(paste("<div class='divShadow'>",
                                                                                   ...
                                                                                   "<p>The aim of this analysis is to test whether respondents tend to elicit items in clusters within their lists. FLARES will test whether items belonging to sub-categories of a given category (defined by user) are mentioned in clusters by respondents.</p>",
                                                                                   ...
                                                                                   "<i>The score is calculated for each sub-category AND the overarching category as a whole</i>.</p>",
                                                                                   "<p><b>Here are a few details on the score's properties:</b></p>",
                                                                                   "<ul>",
                                                                                   ...
                                                                                   "<i>Please refer to the above mentioned article for details on the methods used to calculate the C score.</i></p>",
                                                                                   "</br>",
                                                                                   "<p><b>What FLARES does:</b></p>",
                                                                                   "<ul>",
                                                   ...
                                                   tabsetPanel(selected="Results",
                                                               ...
                                                               tabPanel("Methods",
                                                                        ...
                                                                        HTML(paste("<p><b>Data saturation</b> can be considered as the '<i>point in data collection and analysis when new information produces little or no change</i>' (Guest et al. <a href='http://dx.doi.org/10.1177/1525822X05279903' target='_blank'>2006</a>).</br></br>",
                                                                                   "In order to do so FLARES seeks to log-fit the number of newly cited items as new respondents are added to the sample.</br>",
