                                                   ...
                                                   tabsetPanel(selected="Results",
                                                               ...
                                                               tabPanel("Methods",
                                                                        ...
                                                                        HTML(paste("<div class='divShadow'>",
                                                                                   ...
                                                                                   "<p><b>The optimal partition is chosen as the one maximizing relative intertia loss.</b> In other words the partition for which clusters are the less heterogeneous.",
